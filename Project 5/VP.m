...
hold on
plot(p3);
%legend('M1,M=2','M2,M=2','M3,M=2','M1,M=5','M2,M=5','M3,M=5','M1,M=15','M2,M=15','M3,M=15');
legend('M1,Ts=0.05','M2,Ts=0.05','M3,Ts=0.05','M1,Ts=0.1','M2,Ts=0.1','M3,Ts=0.1','M1,Ts=0.5','M2,Ts=0.5','M3,Ts=0.5');